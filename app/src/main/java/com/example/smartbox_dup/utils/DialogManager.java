...
public class DialogManager {
    ...
    public void showConfirmDialog(String msg, View.OnClickListener clickListener) {
        ...
        customConfirmDialog = new CustomConfirmDialog(GlobalApplication.currentActivity, msg, GlobalApplication.getContext().getString(R.string.vConfirm_text), clickListener);
    ...
    public void showAlertDialog(String msg, View.OnClickListener cancelListener, View.OnClickListener confirmListener) {
        ...
        customAlertDialog = new CustomAlertDialog(GlobalApplication.currentActivity, msg, GlobalApplication.getContext().getString(R.string.vCancel_text),GlobalApplication.getContext().getString(R.string.vConfirm_text), cancelListener, confirmListener);
